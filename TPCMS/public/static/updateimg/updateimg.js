window.onload = function() {
				...
				function readFile() {
					...
					for(var i = 0; i < iLen; i++) {
						...
						reader.onload = function(e) {
							...
							result = '<div class="showdiv"><img class="left" src="/static/updateimg/img/Arrow_left.svg" /><img class="center" src="/static/updateimg/img/delete.svg" /><img class="right" src="/static/updateimg/img/Arrow_right.svg" /></div><img id="srcimgid' + currentReViewImgIndex + '" class="showimg" src="' + this.result + '" />';
				...
				function send() {
					for(var j = 0; j < dataArr.length; j++) {
						var	inputdata;
						inputdata = '<input name="screenshots[]" type="text" id="" value="' + dataArr[j].base64 + '" />';
